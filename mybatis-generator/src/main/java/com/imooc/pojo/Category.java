...
public class Category {
    ...
    /**
     * 获取分类类型;分类得类型，1:一级大分类 2:二级分类 3:三级小分类
     *
     * @return type - 分类类型;分类得类型，1:一级大分类 2:二级分类 3:三级小分类
     */
    ...
    /**
     * 设置分类类型;分类得类型，1:一级大分类 2:二级分类 3:三级小分类
     *
     * @param type 分类类型;分类得类型，1:一级大分类 2:二级分类 3:三级小分类
     */
